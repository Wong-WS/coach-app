...
import { Button, Input, Select, PhoneInput, Modal } from '@/components/ui';
...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-8 max-w-2xl">
              ...
              <div className="flex items-start gap-4">
                ...
                <label className="flex items-center gap-3 w-32 pt-2 cursor-pointer shrink-0">
                  <input
                    ...
                    className="w-4 h-4 rounded border-gray-300 dark:border-zinc-500 text-blue-600 focus:ring-blue-500"
                  />
                    ...
                    {(() => {
                      ...
                      return ranges.map((range, idx) => {
                        ...
                        const borderClass = hasError
                          ...
                          : 'border-gray-300 dark:border-zinc-500 focus:ring-blue-500 focus:border-blue-500';
                        return (
      ...
      {/* Danger zone */}
      <div className="mt-12 border-t border-gray-200 dark:border-[#333333] pt-8">
        <h2 className="text-lg font-semibold text-red-600 dark:text-red-400 mb-2">Danger Zone</h2>
        <p className="text-sm text-gray-500 dark:text-zinc-400 mb-4">
          Reset your account to start fresh. This deletes all students, bookings, lessons, wallets, locations, and payments. Your profile and working hours are kept.
        </p>
        <Button
          variant="ghost"
