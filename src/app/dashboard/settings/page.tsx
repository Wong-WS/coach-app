    ...
    <div className="space-y-8 max-w-2xl">
      ...
      <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-700 p-6">
        ...
        <div className="space-y-4">
          {DAYS.map((day) => (
            <div key={day} className="py-3 border-b border-gray-100 dark:border-zinc-700 last:border-0">
                        ...
                        return (
                          <div key={idx} className="flex items-center gap-2">
                            <select
                              ...
                              className={`text-sm border rounded-lg px-3 py-2 focus:ring-2 bg-white dark:bg-zinc-700 text-gray-900 dark:text-zinc-100 ${borderClass}`}
                            >
